        ...
        <br>
            ...
            <form action="{{url('/update')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="date" name="date" id="date" value="{{$res->date}}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label" >Time</label>
                    <div class="col-sm-8">
                        <input type="time" name="time" id="time" value="{{$res->time}}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Venue</label>
                    <div class="col-sm-8">
                        <input type="text" name="venue" id="venue" value="{{$res->venue}}">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea  name="description" rows="10"id="description" >{{$res->description}}</textarea>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        @if($res->register=='yes')
                        <input type="checkbox" name=register value="yes" checked>
                            @else
